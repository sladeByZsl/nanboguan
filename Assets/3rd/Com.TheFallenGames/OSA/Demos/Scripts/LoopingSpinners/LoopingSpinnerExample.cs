...
namespace Com.TheFallenGames.OSA.Demos.LoopingSpinners
{
	...
	/// </summary>
	public class LoopingSpinnerExample : OSA<NumData, MyItemViewsHolder>
	{
		...
		protected override void Update()
        {
			...
			if (_Params.Snapper)
			{
				...
				if (middleVH != null)
				{
					...
					_Params.currentIndex=_Params.GetItemValueAtIndex(middleVH.ItemIndex);
	...
	public class NumData : BaseParamsWithPrefab
	{
		public int index = 0;
		public int currentIndex;
		public Color selectedColor, nonSelectedColor;
		public int GetItemValueAtIndex(int index) { return index; }
	}
